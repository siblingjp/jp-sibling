...
const schema = z.object({
  ...
  imageOrientation: z.enum(['landscape', 'portrait']).optional(),
  displayMode: z.enum(['image', 'banner']).optional(),
    ...
    const campaign = await prisma.$transaction(async (tx) => {
      ...
      return tx.campaign.update({
        ...
        data: {
          ...
          ...(body.imageOrientation !== undefined && { imageOrientation: body.imageOrientation }),
          ...
          ...(body.showOnPublic !== undefined && { showOnPublic: body.showOnPublic }),

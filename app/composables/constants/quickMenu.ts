...
export const QUICK_MENU: QuickMenuItem[] = [
  ...
  { productName: 'ชาเขียวเย็น', options: ['หวานปกติ 100%'], label: 'ชาเขียว หวานปกติ' },
  ...
  { productName: 'ลาเต้เย็น', options: ['หวานปกติ 100%'], label: 'ลาเต้ หวานปกติ' },
  ...
  { productName: 'คาปูชิโน่เย็น', options: ['หวานน้อย 50%'], label: 'คาปู หวานน้อย' },
  { productName: 'กาแฟชาเขียว', options: ['หวานปกติ 100%'], label: 'กาแฟชาเขียว หวานปกติ' },
  ...
  { productName: 'มัจฉะลาเต้', options: ['หวานปกติ 100%'], label: 'มัจฉะลาเต้ หวานปกติ' },
